          ...
          <div className="bg-white rounded-lg max-w-lg w-full p-6">
            ...
            <div className="border-t pt-4">
              ...
              <input
                ...
                className="w-full max-w-full pl-2 pr-2 sm:pl-3 sm:pr-3 md:pl-4 md:pr-4 py-2 sm:py-2.5 min-h-[48px] border border-gray-300 rounded-md text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
